...
<html>
    ...
    <body>
    <form  action="Editproductcode1.jsp">
<%
         int count=0;
          ...
          while(rs.next())
           {
             ...
             out.print("<div class=inputBox><p style=color: white>Add Product Image</p><input type=file name=txt4 value="+ rs.getString(4)+"><label></label></div>");
...
out.print("<a href=Editproduct.jsp><b style=font-size:20px;>Return</a>");
